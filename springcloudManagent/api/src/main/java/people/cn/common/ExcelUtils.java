...
public class ExcelUtils<T> {
     ...
     * @param response
     */
    private void setHeard(Workbook workbook, HttpServletResponse response,String tableName) throws IOException {
     ...
     * @param row
     */
    private void setCellValue(T object, XSSFRow row) throws IllegalAccessException {
        int colNum = 0;
    ...
    public void export(String tableName, List<T> objs, HttpServletResponse response) throws IllegalAccessException, IOException {
        ...
        setHeard(workbook,response,tableName);
    }
    /***
     * 通过hutool工具类实现表单下载
     */
